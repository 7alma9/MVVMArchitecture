...
import com.xammy.mvvmarchitecture.util.DialogUtils
...
abstract class BaseActivity<B : ViewDataBinding> : AppCompatActivity(), BaseView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getViewModel()?.outcomeLiveData?.observe(this, Observer {
            when (it) {
                is com.xammy.mvvmarchitecture.api.Result.Loading -> {
                    if (it.showLoader)
                        loaderVisibility(true)
                }
                is com.xammy.mvvmarchitecture.api.Result.Success -> loaderVisibility(false)
                is com.xammy.mvvmarchitecture.api.Result.Failure -> loaderVisibility(false)
                is com.xammy.mvvmarchitecture.api.Result.NetworkError -> loaderVisibility(false)
